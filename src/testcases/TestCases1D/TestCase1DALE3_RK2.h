#ifndef TURBO_TestCases_TestCases1D_TestCase1DALE3_RK2
#define TURBO_TestCases_TestCases1D_TestCase1DALE3_RK2
...
class TestCase1DALE3_RK2 : public TestCase {
protected:
...
public:
	...
	Configuration& PrepareConfiguration() {
		...
		_configuration.BoundaryConditions["left"].MaterialName = "First";
		...
		_configuration.BoundaryConditions["right"].MaterialName = "Second";
		...
		_configuration.RungeKuttaOrder = 2;		
...
//Test constant's
const int TestCase1DALE3_RK2::nCells = 100;
const double TestCase1DALE3_RK2::Lx = 1.0;
const double TestCase1DALE3_RK2::TimeMax = 0.2;

//Left state density, pressure and velocity
const double TestCase1DALE3_RK2::roL = 1.0;
const double TestCase1DALE3_RK2::pL = 1.0;
const double TestCase1DALE3_RK2::uL = 0.0;
const double TestCase1DALE3_RK2::gammaL = 1.667;

//Right state density, pressure and velocity
const double TestCase1DALE3_RK2::roR = 0.125;
const double TestCase1DALE3_RK2::pR = 0.1;
const double TestCase1DALE3_RK2::uR = 0.0;
const double TestCase1DALE3_RK2::gammaR = 1.2;
